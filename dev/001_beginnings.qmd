...
GeomSankey <- ggproto( 'GeomSankey', Geom
					 ...
					 , setup_data = function( data, params ){
						...
						data_nodes_pos <- data_nodes %>% 
							...
							mutate( xend=x
							      , linewidth=GeomSegment$default_aes$linewidth
					 ...
					 , draw_panel = function( self, data, panel_params, coord ){
						node_grob <- GeomSegment$draw_panel( data, panel_params, coord )
						
						ggplot2:::ggname( 'geom_sankey', grid::grobTree(
							node_grob	
						))
					   }
)
